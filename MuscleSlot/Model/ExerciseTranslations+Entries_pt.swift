//
//  ExerciseTranslations+Entries_pt.swift
//  MuscleSlot
//
//  76種目のポルトガル語訳本体。キーは Exercise.name（日本語）。
...
extension ExerciseTranslations {
    ...
    static let entries_pt: [String: Entry] = [
        "腕立て伏せ": Entry(
        ...
        "チンニング（逆手懸垂）": Entry(
            name: "Elevações na barra supinada",
            detail: "Uma elevações na barra com pegada supinada (palmas para você). Atinge muito o bíceps além das costas e é mais fácil de puxar que a versão pronada.",
            steps: [
        ...
        "バックエクステンション": Entry(
            ...
            steps: [
                "Deite-se de bruços com as mãos junto à cabeça ou no peito.",
        ...
        "スーパーマン": Entry(
            name: "Superman",
            detail: "Deite-se de bruços e levante braços e pernas ao mesmo tempo, segurando alguns segundos. Contrai todas as costas e a lombar. Continue respirando.",
            steps: [
        ...
        "リバーススノーエンジェル": Entry(
            ...
            detail: "Deite-se de bruços, erga um pouco o peito e mova os braços de cima da cabeça até o quadril. Atinge o trapézio inferior e os músculos ao redor das escápulas para melhorar a postura.",
            steps: [
                "Deite-se de bruços e erga um pouco o peito do chão.",
        ...
        "ラットプルダウン": Entry(
            ...
            detail: "Um exercício guiado que dá largura às costas mesmo se a elevações na barra for difícil. Erga o peito, puxe a barra à clavícula e puxe com os dorsais deprimindo as escápulas.",
            steps: [
        ...
        "ヒップリフト": Entry(
            ...
            detail: "Deite-se de costas com os joelhos flexionados e eleve o quadril em linha reta. Contraia forte os glúteos no topo. Empurre pelo quadril sem arquear a lombar.",
            steps: [
                "Deite-se de costas com os joelhos flexionados e os pés na largura do quadril.",
        ...
        "レッグプレス": Entry(
            ...
            steps: [
                "Sente-se e coloque os pés na largura dos ombros no centro da plataforma.",
        ...
        "レッグカール": Entry(
            name: "Flexão de perna na máquina",
        ...
        "レッグエクステンション": Entry(
            ...
            steps: [
                "Sente-se com o rolo contra os tornozelos.",
        ...
        "Yレイズ（うつ伏せ）": Entry(
            ...
            detail: "Deite-se de bruços e eleve os braços em Y. Atinge os deltoides posteriores e o trapézio inferior para ajudar a corrigir ombros caídos.",
            steps: [
                "Deite-se de bruços e estenda os braços acima da cabeça em Y.",
        ...
        "チンニング（腕狙い）": Entry(
            name: "Elevações na barra supinada fechada",
            detail: "Elevações na barra supinada com pegada fechada para focar no bíceps. Evite balançar e concentre-se em puxar flexionando os braços.",
            steps: [
        ...
        "リバースプランク": Entry(
            ...
            steps: [
                "Sente-se e apoie as mãos no chão atrás, sob os ombros.",
        ...
        "逆手テーブルロウ": Entry(
            ...
            steps: [
                "Deite-se de barriga para cima sob uma mesa firme.",
        ...
        "クランチ": Entry(
            ...
            detail: "Deite-se de costas com os joelhos flexionados e enrole o tronco só até as escápulas saírem do chão. Atinge o abdômen superior. Enrole com o abdômen, não com o pescoço.",
            steps: [
                "Deite-se de costas com os joelhos flexionados, mãos junto à cabeça ou no peito.",
        ...
        "レッグレイズ": Entry(
            ...
            detail: "Deite-se de costas, eleve as pernas juntas e desça devagar. Atinge o abdômen inferior. Pressione as mãos no chão para a lombar não arquear.",
            steps: [
                "Deite-se de costas com as mãos ao lado ou sob o quadril.",
        ...
        "バイシクルクランチ": Entry(
            ...
            steps: [
                "Deite-se de costas com as mãos junto à cabeça e as pernas elevadas.",
        ...
        "ロシアンツイスト": Entry(
            ...
            steps: [
                "Sente-se com os joelhos flexionados e incline o tronco para trás.",
        ...
        "デッドバグ": Entry(
            name: "Dead bug",
            detail: "Deite-se de costas com braços e pernas para cima e estenda devagar os membros opostos. Um exercício de core amigável às costas. Mantenha a lombar pressionada no chão.",
            steps: [
                "Deite-se de costas com os braços para o teto e os joelhos a 90 graus.",
        ...
        "ケーブルクランチ": Entry(
            ...
            detail: "Ajoelhe-se segurando uma polia e enrole o tronco para baixo. Permite carregar muito o abdômen. Não puxe com os braços — arredonde as costas e enrole com o abdômen.",
            steps: [
        ...
        "ホローホールド": Entry(
            name: "Hollow hold",
            detail: "Deite-se de costas, estenda braços e pernas e mantenha uma forma de banana com a lombar no chão. Um exercício isométrico para todo o core. Baixe os membros se as costas saírem do chão.",
            steps: [
                "Deite-se de costas com os braços acima da cabeça e as pernas retas.",
